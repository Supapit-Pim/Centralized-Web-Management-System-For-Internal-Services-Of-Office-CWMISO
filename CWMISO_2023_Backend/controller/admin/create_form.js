...
const tableName = query.Table_Create_Form;
const Where_Delete = query.Where_Delete;
const Where_UnDelete = query.Where_UnDelete;

const joinTable = [tableName, "list_service", "company"];
const joinColumns = [`${tableName}.*`, `company.id AS company_id`];
const joinConditions = `${tableName}.list_service_id = list_service.id AND list_service.company_id = company.id`;
