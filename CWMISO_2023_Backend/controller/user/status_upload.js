...
const tableName = query.Table_Status_Upload;
const Where_Delete = query.Where_Delete;
const Where_UnDelete = query.Where_UnDelete;


const joinTable = [tableName, "list_upload", "list_personnel", "company"];
const joinColumns = [`${tableName}.*`, `company.id AS company_id`, `list_personnel.id AS list_personnel_id`];
const joinConditions = `${tableName}.list_upload_id = list_upload.id AND list_upload.list_personnel_id = list_personnel.id AND list_personnel.company_id = company.id`;


const StatusUploadController = {
...
module.exports = StatusUploadController;
